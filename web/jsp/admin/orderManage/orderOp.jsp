...
<body>
	...
	<h2 class="text-center">待处理订单列表</h2>
					...
					<c:forEach items="${orderList}" var="i">
						<tr>
							...
							<td>
								...
								<a class="btn btn-info btn-sm" href="jsp/admin/OrderManageServlet?action=ship&id=${i.orderId}" onclick="return confirm('确定要发货了么！')">发货</a>
							</td>
						</tr>
					</c:forEach>
				</c:when>
